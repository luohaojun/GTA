...
static cv::String weightpath ="/home/luo/gta/src/AUTO/offb/src/include/yolo/yolov7-tiny_luo_best.weights";
static cv::String cfgpath ="/home/luo/gta/src/AUTO/offb/src/include/yolo/yolov7-tiny_luo.cfg";
...
{
    cv::VideoWriter video("/home/luo/gta/src/AUTO/offb/src/include/yolo/tracking.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videoyolo("/home/luo/gta/src/AUTO/offb/src/include/yolo/yolo.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    cv::VideoWriter videogt("/home/luo/gta/src/AUTO/offb/src/include/yolo/gt.avi", cv::VideoWriter::fourcc('M','J','P','G'), 8, cv::Size(640,480));
    ...
    while(ros::ok())
    {
        ...
        if(!frame.empty())
        {
            ...
            if (found)
            {
                ...
                ofstream save("/home/luo/gta/src/AUTO/offb/src/include/yolo/gt.txt", ios::app);
                save<<counter<<endl;
            ...
            if(temp.size()!=0)
            {
                for(auto stuff:temp)
                {
                    ...
                    if(stuff.classnameofdetection=="traffic light")
                    {
